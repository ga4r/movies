...
import YearsButton from "../YearsButton/YearsButton";
...
function BurgerMenu() {
  ...
  const [burgerMenuCondition, setBurgerMenuCondition] = useState(false);

  const openBurgerMenu = () => {
    setBurgerMenuCondition(true);
    document.querySelector(".burgerMenuOpenBtn").style.display = "none";
  };
  ...
  return (
    <>
      <div className="headerBurgerMenuWrapper">
        <span className="burgerMenuOpenBtn" onClick={openBurgerMenu}>
          |||
        </span>
        {burgerMenuCondition ? (
          <>
            <div className="headerBurgerMenu">
              <span onClick={closeBurgerMenu} className="burgerMenuCloseBtn">
                ✖
              </span>
              <nav>
                <ul className="headerBurgerMenuNav">
                  <li>
                    <Link to="/" onClick={closeBurgerMenu} >Home</Link>
                  </li>
                  <li>
                    <a onClick={closeBurgerMenu} href="#main">Movie</a>
                  </li>
                  <li>
                    <CategoriesButton setBurgerMenuCondition={setBurgerMenuCondition} genres={genres} />
                  </li>
                  <li>
                    <YearsButton setBurgerMenuCondition={setBurgerMenuCondition} years={years} />
                  </li>
                  <li>
                    <a onClick={closeBurgerMenu} href="#">Premium</a>
                  </li>
                </ul>
              </nav>
              <div className="headerBurgerMenuButtons">
                <SearchBar setBurgerMenuCondition={setBurgerMenuCondition} />
                <div className="headerBurgerMenuLanguageSwitch">
                  <svg
                    width="21"
                    height="22"
                    viewBox="0 0 21 22"
                    ...
                    <defs>
                      <clipPath id="clip0_7_17">
                        <rect
                          ...
                          height="20.1013"
                          fill="white"
                          transform="translate(0 0.941528)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
                  <span className="headerBurgerMenuLanguage">EN</span>
                  <span className="headerBurgerMenuLanguageSwitcher">
                    <svg
                      width="12"
                      height="9"
                      viewBox="0 0 12 9"
                    ...
                    >
                      <path
                        d="M1 1L5.6336 6.51086L10.2672 1"
                        stroke="white"
                        strokeWidth="2"
                      />
                    </svg>
                ...
                <span className="headerBurgerMenuLogin">Sign in</span>
              </div>
            </div>
          </>
        ) : null}
