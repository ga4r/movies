    ...
    <>
      <nav>
        <ul className="headerNav">
          ...
          <li>
            <CategoriesButton genres={genres} />
          </li>
          <li>
            <YearsButton years={years} />
          </li>
          <li>
            <a href="#">Premium</a>
          </li>
      ...
      <div className="headerButtons">
        <SearchBar />
        <div className="headerLanguageSwitch">
          <svg
            width="21"
            height="22"
            viewBox="0 0 21 22"
          ...
          <span className="headerLanguageSwitcher">
            <svg
              width="12"
              height="9"
              viewBox="0 0 12 9"
        ...
        <span className="headerLogin">Sign in</span>
      </div>
    </>
  );
}
